...
const cifras = 123
let variable
let suma = Math.floor(cifras / 100)
variable = cifras % 100
suma = suma + Math.floor(variable / 10) + (variable % 10)
console.log("SUMA DE CIFRAS AL CUBO")
console.log(suma ** 3)
...
const dinero = 8965
const socioA = dinero*0.30
const socioB = dinero*0.20
const socioC = dinero*0.60
console.log("REPARTICIÓN DE LOS SOCIOS")
console.log(socioA)
console.log(socioB)
console.log(socioC)
