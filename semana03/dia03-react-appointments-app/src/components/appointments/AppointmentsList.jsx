...
const AppointmentsList = ({ appointments, onRemove, onEdit }) => {
  ...
  return (
    <section className="m-1/2 p-4 rounded-lg">
      <h2 className="text-2xl text-center mb-4">Listado de Citas</h2>
      <div className="flex flex-col gap-3 mb-4">
        {appointments.map((appointment) => {
          return (
            <div className="border-2 border-sky-500 p-3 rounded-lg bg-sky-300" key={appointment.id}>
              <div className="mb-2">
              ...
              <div className="flex flex-col gap-3 mt-3">
                ...
                <button className="p-2 bg-sky-600 text-white rounded-lg cursor-pointer" onClick={() => onEdit(appointment)}>
                  Editar
                </button>
                <button className="p-2 bg-red-500 text-white rounded-lg cursor-pointer" onClick={() => onRemove(appointment.id)}>
                  Eliminar
                </button>
              </div>
            </div>
